  ...
  return (
    <div className="mt-10 grid grid-cols-1 gap-4 md:grid-cols-3">
      <Card className="col-span-1 border-none bg-gray-100 p-8 md:col-span-2 text-justify">
        ...
        <p className="mt-4 text-muted-foreground md:text-lg">👋 I was introduced to computers at a young age and have since developed a deep fascination for coding and its potential to create and innovate. While my professional journey led me to the food industry, where I honed my skills in team leadership, time management, and problem-solving, I'm now embracing the software development industry with dedication. I'm here to solve your problems with creativity and precision, ready to bring your ideas to life through code! 💻✨</p>
        <Dialog>
          <DialogTrigger>
